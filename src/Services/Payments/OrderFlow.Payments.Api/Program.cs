...
using OrderFlow.Payments.Api.ExceptionHandling;
using OrderFlow.Payments.Api.Middleware;
...
builder
    ...
    .ConfigureResource(resourceBuilder => resourceBuilder.AddService("OrderFlow.Payments"))
