...
public sealed class NotificationTests
{
    ...
    {
        var notification = Notification.Create("user@example.test", "Order confirmed", "Your order is ready.", NotificationChannel.Email);
    ...
    public void Invalid_recipient_is_rejected() =>
        Assert.Throws<DomainException>(() => Notification.Create("not-email", "Subject", "Body", NotificationChannel.Email));
}
